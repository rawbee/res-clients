...
- [x] **Proposal deck rendered (Aug 13):** `rfp/PROPOSAL-DECK.html` — 32 slides, 16:9, in the tryres.ai brand language (D10), prints to widescreen PDF. Open items show as blue markup. Must be manually re-synced whenever PROPOSAL.md changes; **font licensing is an open question before it's shared publicly**
