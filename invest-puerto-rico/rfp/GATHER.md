...
- [ ] **G-11 / G-12 / G-13:** 2–3 case studies. For each, insist on:
...
| G-11–13 | **→ HAI:** Case studies with quantified results. Best candidates: Masterworks paid-media attribution at $4M/mo; the $2K/day → $1M/day capital-raised flywheel and what the systems/ops contribution to it was; HubSpot lifecycle work at Masterworks; a current Res engagement (anonymized is fine). Each needs at least one hard number — the RFP scores measurable results in data normalization, system efficiency, or campaign attribution. | **Hai** | Aug 21 |
| G-39 | **Robby's resume — DONE Aug 12:** Worthy corrected to Jan 2025–Apr 2026; Res AI entry added (marked DRAFT, needs Robby to add current engagements); Carat corrected to 2004–Nov 2008 (contract 2004–2006, full-time 2006–2008); summary updated 15+ → 20+ years. **Still needed:** Robby to expand the Res AI bullet before it ships. | Robby | Aug 21 |
